...
<section class="form-container">
   ...
   <form action="" method="post"  style="background-color:#C6BBB4;">
      <h3>update now</h3>
      ...
      <input type="password" name="cpass" required placeholder="confirm your new password" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
